...
import { ChevronRight, ChevronsUpDown, FolderOpen, GalleryVerticalEnd, LogOut, MessageSquare, Package, Plus, Settings, SquareTerminal, TableProperties, User, } from "lucide-react";
...
function NavMain({ items, }) {
    return (<SidebarGroup>
      ...
      <SidebarMenu>
        {items.map((item) => (<Collapsible key={item.title} defaultOpen={item.isActive} className="group/collapsible">
            <SidebarMenuItem>
