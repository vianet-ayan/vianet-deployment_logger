...
import type { InventoryItem } from "@/adminstore/slices/inventorySlice"

export default function Inventory() {
  const { items, loading } = useSelector((state: { inventory: { items: InventoryItem[]; loading: boolean; error: string | null } }) => state.inventory)
