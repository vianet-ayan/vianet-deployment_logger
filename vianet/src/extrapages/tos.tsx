export function TermsOfService() {
  return (
    <div className="mx-auto max-w-3xl p-6">
      ...
      <p className="text-muted-foreground mb-4">Last updated: September 15, 2026</p>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed mb-2">
          All content, trademarks, and data on this platform are the property of Vianet or
          its licensors. You may not copy, modify, distribute, or reverse-engineer any part
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed mb-2">
          To the maximum extent permitted by law, Vianet shall not be liable for any indirect,
